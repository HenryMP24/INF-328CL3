 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://mavenproject5.mycompany.com/", wsdlLocation = "http://localhost:8080/mavenproject5/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://mavenproject5.mycompany.com/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/mavenproject5/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://mavenproject5.mycompany.com/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://mavenproject5.mycompany.com/", "NewWebServicePort"), NewWebService.class, features);
    }
